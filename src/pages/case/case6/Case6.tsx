...
// import { ReactComponent as IconAccNav } from '@/assets/svg/icon_accNav.svg'; // vite-plugin-svgr@2.4.0 语法
import iconAcc from '@/assets/svg/icon_accNav.svg'; // 静态资源引入 + 放入<img />使用, 不推荐
import IconAccNav from '@/assets/svg/icon_accNav.svg?react'; // vite-plugin-svgr@4.3.0 语法
